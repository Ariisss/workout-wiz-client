...
const formSchema = z.object({
  ...
  sex: z.preprocess((value) => value === "true" || value === true, z.boolean()),
                    ...
                    >
                      ...
                      >
                        <SelectTrigger className="cursor-pointer">
                          ...
                          <SelectValue
                            placeholder={
                              <p className="text-muted-foreground hover:text-gray-800 ">
                                Select Sex
                              </p>
                            }
                          />
                      ...
                      <SelectContent className="bg-background-darker font-sans">
                        <SelectItem value="false" className="hover:bg-primary">
                          Male
                        </SelectItem>
